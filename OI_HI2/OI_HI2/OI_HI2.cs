    ...
    public partial class Form38 : Form
    {
        ...
        private void Set_default_series2()
        {
            ...
            for (int i = 0; i <5; i++)
            {
                ...
                if (i == 0)
                {
                    string xline = "46.0177	37.52213	27.25664	22.65487	18.76106	17.69912	16.99115	16.99115	16.99115	17.34513	17.34513	16.99115	14.86726	12.0354	7.433628";
                    string yline = "938.9067	885.8521	810.2894	736.3344	633.4405	561.0933	448.553	355.3055	274.9196	202.5723	143.0868	102.8939	67.52412	46.62379	27.33119";
                ...
                {
                    string xline = "93.45132	82.47787	69.38053	49.9115	37.16814	28.31858	22.30088	19.46903	19.11504	19.46903	20.53097	21.59292	19.46903	15.9292	11.68142	8.849558";
                    string yline = "628.6174	618.9711	604.5016	573.955	543.4084	503.2154	454.9839	385.8521	327.9743	270.0965	184.8875	115.7556	77.17042	49.83923	28.93891	12.86174";
                ...
                {
                    string xline = "10.95406	34.98233	68.19788	97.5265	122.6148	145.2297	170.6714	189.0459	189.7345";
                    string yline = "8.05153	30.59581	54.7504	67.63285	70.85346	64.41224	45.08857	6.441224	3.215434";
                    char[] delimiterChars = { ' ', '\t' };
                    string[] xwords = xline.Split(delimiterChars);
                    string[] ywords = yline.Split(delimiterChars);
                    //Ricker Wavelet
