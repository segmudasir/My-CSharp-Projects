...
namespace My_Project
{
    public partial class Form40 : Form
    {
        ...
        public Form40()
        {
            ...
            chart1.ChartAreas[0].AxisX.Minimum = 66;
            chart1.ChartAreas[0].AxisX.Maximum = 72;
            chart1.ChartAreas[0].AxisX.Interval = 1;
            chart1.ChartAreas[0].AxisX.LabelStyle.Enabled = true;
            chart1.ChartAreas[0].AxisX.LabelStyle.Format = "0.0";
            chart1.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Arial", 11, FontStyle.Bold);
           
            chart1.ChartAreas[0].AxisY.Minimum = 23.5;
            chart1.ChartAreas[0].AxisY.Maximum = 28.5;
            chart1.ChartAreas[0].AxisY.Interval = 1;          
            chart1.ChartAreas[0].AxisY.LabelStyle.Enabled = true;
            chart1.ChartAreas[0].AxisY.LabelStyle.Format = "0.0";
            chart1.ChartAreas[0].AxisY.LabelStyle.Font = new Font("Arial", 11, FontStyle.Bold);


            chart1.ChartAreas[0].InnerPlotPosition.X = 8;
            chart1.ChartAreas[0].InnerPlotPosition.Y = 1;

            chart1.ChartAreas[0].InnerPlotPosition.Height = 95F;
            chart1.ChartAreas[0].InnerPlotPosition.Width = 95F;
        ...
        {
            int marker_Size = int.Parse(textBox9.Text);
            ...
            chart.Series[well_name].MarkerSize = marker_Size;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            textBox6.Text = 66.ToString();
            textBox5.Text = 72.ToString();
            textBox8.Text = 23.5F.ToString();
            textBox7.Text = 28.5F.ToString();
        ...
        private void Browse_Click(object sender, EventArgs e)
        {
            ...
            {
                chart1.ChartAreas[0].BackImage = ofd.FileName;
                chart1.ChartAreas[0].BackImageAlignment = ChartImageAlignmentStyle.Center;
                chart1.ChartAreas[0].BackImageWrapMode = ChartImageWrapMode.Scaled;                
            }
        }

        private void update_scale_Click(object sender, EventArgs e)
        {
            xmin = float.Parse(textBox6.Text);
            xmax = float.Parse(textBox5.Text);
            ymin = float.Parse(textBox8.Text);
            ymax = float.Parse(textBox7.Text);

            chart1.ChartAreas[0].AxisY.Minimum = ymin;
            chart1.ChartAreas[0].AxisY.Maximum = ymax;
            chart1.ChartAreas[0].AxisY.Interval = (ymax - ymin) / 6;
            chart1.ChartAreas[0].AxisY.LabelStyle.Format = "0.0";
            chart1.ChartAreas[0].AxisY.LabelStyle.Font = new Font("Arial", 11, FontStyle.Bold);

            chart1.ChartAreas[0].AxisX.Minimum = xmin;
            chart1.ChartAreas[0].AxisX.Maximum = xmax;
            chart1.ChartAreas[0].AxisX.Interval = (xmax - xmin) / 6;
            chart1.ChartAreas[0].AxisX.LabelStyle.Format = "0.0";
            chart1.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Arial", 11, FontStyle.Bold);
        }
